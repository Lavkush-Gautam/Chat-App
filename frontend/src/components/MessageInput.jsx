        ...
        <div className='p-4 w-full'>
                ...
                imagePreview && (
                    <div className='mb-3 flex items-center gap-2'>
                        <div className='relative'>
                            <img src={imagePreview} alt="preview" className='w-20 h-20 object-cover rounded-lg border-zinc-700' />
            ...
            <form onSubmit={handleSendMessage} className='flex items-center gap-2'>
                <div className='flex flex-1 gap-2'>
                    <input type="text" className='w-full input input-bordered rounded-lg input-sm sm:input-md' placeholder='Type a messages....' value={text} onChange={(e) => setText(e.target.value)} />
                ...
                <button className='btn btn-sm btn-circle' disabled={!text.trim() && !imagePreview} type='submit'>
                    <Send size={22} />
                </button>
            </form>
